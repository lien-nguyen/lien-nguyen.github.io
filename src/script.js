...
function addTrainingAndCertsSection() {
  fetch('/static/training-and-certs.html') // Fixed path
    .then(response => {
      if (!response.ok) {
...
function loadAboutMe() {
  fetch('/static/about-me.html') // Fixed path
...
function loadEducation() {
  fetch('/static/education.html') // Fixed path
    .then(response => response.text())
    .then(data => {
...
function loadExperiences() {
  fetch('/static/experiences.html') // Fixed path
    .then(response => response.text())
    .then(data => {
...
function loadProjects() {
  fetch('/static/projects.html') // Fixed path
    .then(response => response.text())
    .then(data => {
...
function loadSkills() {
  fetch('/static/skills.html') // Fixed path
    .then(response => response.text())
    .then(data => {
